...
/**
 * An activity representing a list of Clienti. This activity
 ...
 * {@link ClienteListFragment} and the item details
 * (if present) is a {@link ClienteDetailFragment}.
 * <p>
 * This activity also implements the required
 * {@link ClienteListFragment.Callbacks} interface
 * to listen for item selections.
 */
public class ClienteListActivity extends FragmentActivity
        implements ClienteListFragment.Callbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.cliente_detail_container) != null) {
            ...
            ((ClienteListFragment) getSupportFragmentManager()
                    .findFragmentById(R.id.cliente_list))
