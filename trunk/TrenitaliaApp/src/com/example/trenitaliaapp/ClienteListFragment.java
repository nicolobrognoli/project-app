...
public class ClienteListFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.item_list_layout, container,
				false);
		...
		if (userList_ != null && userList_.size() > 0) {
			ClientAdapter clientAdapter = new ClientAdapter(getActivity(),
					R.layout.list_row, userList_);
		...
		ImageButton nuovoButton = ((ImageButton) rootView
				.findViewById(R.id.button_nuovo));
	...
	public void setActivateOnItemClick(boolean activateOnItemClick) {
		list_.setChoiceMode(activateOnItemClick ? ListView.CHOICE_MODE_SINGLE
